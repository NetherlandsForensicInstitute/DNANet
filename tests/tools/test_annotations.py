...
class TestAnnotationStoreReadAll:
    def test_reads_csv_file(self, tmp_path):
        ...
        with open(path, 'w', newline='') as f:
            ...
            writer.writerow(
                ['Alice', '2024-01-01', 'sample1', 'blue', '10', '20', '-1', 'Allele', '1.0']
            )
        store = AnnotationStore(path)
        rows = store.read_all()
        assert len(rows) == 1
    ...
    def test_reads_folder(self, tmp_path):
        for i in range(3):
            ...
            with open(path, 'w', newline='') as f:
                ...
                writer.writerow(HEADER)
                writer.writerow(
                    ['Bob', '2024-01-01', f'sample{i}', 'blue', '10', '20', '-1', 'Stutter', '1.0']
                )
...
class TestAnnotationStoreLoadSpans:
    ...
    def store_with_data(self, tmp_path):
        ...
        with open(path, 'w', newline='') as f:
            ...
            writer.writerow(HEADER)
            writer.writerow(
                ['Alice', '2024-01-01', 'sample1', 'blue', '10', '20', '5', 'Allele', '1.0']
            )
            writer.writerow(
                ['Bob', '2024-01-01', 'sample1', 'green', '30', '40', '-1', 'Stutter', '1.0']
            )
            writer.writerow(
                ['Alice', '2024-01-01', 'sample2', 'red', '50', '60', '-1', 'PullUp', '1.0']
            )
